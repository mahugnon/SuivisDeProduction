...
<t:template>
				...
				<div class="panel-heading">
					<div class="row">
						...
						<div class="col-xs-9 text-right">
							...
							<div>Information Générale</div>
						</div>
					</div>
				</div>
				<a href="<c:url value="/kosu_connect/admin/info_generale" />">
					<div class="panel-footer">
						<span class="pull-left">Voir Details</span> <span
				...
				<div class="panel-heading">
					<div class="row">
						...
						<div class="col-xs-9 text-right">
							...
							<div>Indicateur de productivité</div>
						</div>
					</div>
				</div>
				<a href="#">
	...
	<div class="row">
		<div class="col-lg-8">
			<!-- Graph PDG -->
			<sc:authorize access="hasAnyRole('IT_MANAGER','PDG')">
				<div class="panel panel-primary">
					<div class="panel-heading">
						<i class="fa fa-bar-chart-o fa-fw"></i> PRODUCTION DE MOIS

					</div>
					<!-- /.panel-heading -->
					<div class="panel-body" id="production_container">
			...
			<!-- Graph SMRT -->
			<sc:authorize access="hasAnyRole('IT_MANAGER','SMRT')">
				<div class="panel panel-primary">
					<div class="panel-heading">
						<i class="fa fa-bar-chart-o fa-fw"></i> PRODUCTION DE MOIS
					...
					<!-- /.panel-heading -->
					<div class="panel-body" id="smrt_production_container">
						<canvas id="smrt_results-graph"></canvas>
					</div>
					<!-- /.panel-body -->
				</div>
			</sc:authorize>
			...
			<!-- Graph MMRT -->
			<sc:authorize access="hasAnyRole('IT_MANAGER','MMRT')">
				<div class="panel panel-primary">
					<div class="panel-heading">
						<i class="fa fa-bar-chart-o fa-fw"></i> PRODUCTION DE MOIS
					...
					<!-- /.panel-heading -->
					<div class="panel-body" id="mmrt_production_container">
						<canvas id="mmrt_results-graph"></canvas>
					</div>
					<!-- /.panel-body -->
				</div>
			</sc:authorize>
			...
			<!-- Graph BMRT -->
			<sc:authorize access="hasAnyRole('IT_MANAGER','BMRT')">
				<div class="panel panel-primary">
					<div class="panel-heading">
						<i class="fa fa-bar-chart-o fa-fw"></i> PRODUCTION DE MOIS
					...
					<!-- /.panel-heading -->
					<div class="panel-body" id="bmrt_production_container">
						<canvas id="bmrt_production_results-graph"></canvas>
					</div>
					<!-- /.panel-body -->
				</div>
				<!-- /.panel -->
			...
			<!-- Graph Contre maitre-->
			<sc:authorize access="hasAnyRole('IT_MANAGER','CONTRE_MAITRE')">
			<div class="panel panel-primary">
				<div class="panel-heading">
					<i class="fa fa-bar-chart-o fa-fw"></i> PRODUCTION DE MOIS
				...
				<!-- /.panel-heading -->
				<div class="panel-body" id="contremaitre_production_container">
					<canvas id="contremaitre_results-graph"></canvas>
				</div>
				<!-- /.panel-body -->
			</div>
			</sc:authorize>
