...
<div class="alert alert-success alert-dismissable"
				...
				<div class="col-md-3">
					<a href="#" class="btn btn-primary btn-block margin-bottom">Composer
						un message</a>
					...
					<div class="box box-solid">
						...
						<div class="box-body no-padding">
							<ul class="nav nav-pills nav-stacked">
								<li class="active" id="recu" onclick="recu()"><a href="#"><i
										class="fa fa-inbox"></i>Message reçu<span
										class="label label-danger pull-right" id="nouvMessages"></span></a></li>
								<li id="envoye" onclick="envoie()"><a href="#"><i
										class="fa fa-envelope-o"></i> Envoyé</a></li>
...
<!-- 						/.pull-right -->
					...
					<form action="/kosu_connect/admin/sendMessage" id="sendMessageForm" method="post">
						<div class="box box-primary">

							<!-- /.box-header -->
							<div class="box-body">
								<fieldset>
									<legend class="box-title pull-center">Composer un
										message</legend>
									...
									<fieldset>
										...
										<div class="form-group">
											<label class="radio-inline"> <input type="radio"
												name="role" value="1" />SUPER ADMIN
											</label> <label class="radio-inline"> <input type="radio"
												name="role" value="2" /> ADMIN
											</label> <label class="radio-inline"> <input type="radio"
												name="role" value="3" /> CONSULTANT
											</label> <label class="radio-inline"> <input type="radio"
												name="role" value="4" /> TOUT
											</label>
										</div>
									</fieldset>
									<hr class="divider" />
									<div class="form-group">
										<input class="form-control" id="sujet" name="sujet"
											placeholder="Sujet :">
									</div>
									<div class="form-group">
...
<script type = "text/javascript" 
	...
	<script src="https://cdnjs.cloudflare.com/ajax/libs/intl-tel-input/12.0.2/js/intlTelInput.min.js"></script>
