				...
				<div class="modal-body">
					...
					<div class="profile">
						...
						<div class=" profile-avatar-wrap">
							<c:if test="${current.photo !=null}">
								<img alt="User Pic" class="img  img-circle profile-avatar" id="profile-avatar"
									src="${pageContext.request.contextPath}/kosu_connect/admin/loadUserProfile/${current.idUser}" />
							...
							<c:if test="${current.photo==null}">
								<c:if test="${current.sexe=='Féminin' }">
									<img id="profile-avatar"
										class="img img-circle profile-avatar profile-avatar" src="${pageContext.request.contextPath}/resources/images/female.png" />
								</c:if>
							</c:if>
						</div>
						
					<input type="file" class="form-group" id="uploader">
					</div>
				</div>
