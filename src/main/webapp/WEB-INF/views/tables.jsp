                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
								...
								<tr class="">
									<td><c:if test="${user.photo !=null}">
											<img class="img-circle image_user"
												src="${pageContext.request.contextPath}/kosu_connect/admin/loadUserProfile/${user.idUser}" />

										</c:if> <c:if test="${user.photo==null}">
											<c:if test="${user.sexe=='Masculin' }">
												<img class="image_user"
													src="${pageContext.request.contextPath}/resources/images/male.png" />
											</c:if>
										</c:if> <c:if test="${user.photo==null}">
											<c:if test="${user.sexe=='Féminin' }">
												<img class="image_user"
									...
									<td><a data-toggle="modal" data-target="#umodal"
										onclick="showEditModal(${user.idUser})">Edit</a></td>
									<td><a data-toggle='modal' data-target='#dmodal'
										onclick="showDeleteModal( ${user.idUser})">Delete</a></td>
								</tr>
