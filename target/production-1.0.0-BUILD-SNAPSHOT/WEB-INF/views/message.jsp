...
<body>
					...
					<div class="box box-solid">
						...
						<div class="box-body no-padding">
							<ul class="nav nav-pills nav-stacked">
								<li class="active" id="recu" onclick="recu()"><a href="#" ><i class="fa fa-inbox"></i>Message reçu<span class="label label-danger pull-right" id="nouvMessages"></span></a></li>
	...
	<script src="<%=request.getContextPath()%>/resources/js/model/humanize-duration.js"></script>
	...
	<script src="<%=request.getContextPath()%>/resources/js/model/user.js"></script>
